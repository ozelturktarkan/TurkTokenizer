...
Relation E09 completed from the verified E08 boundary with combined TRAIN loss `0.1948`, macro F1 `0.80110980`, minimum-family/OBJECT F1 `0.71530249`, `POSS_HEAD=0.79958463`, `OBJECT=0.71530249`, `PARTICIPLE_HEAD=0.81331988`, `CASE_GOVERNOR=0.87623220`, `UAS=0.87581993`, `LAS=0.75505436`, `UPOS=0.91917513`, and selection score `0.78069476`. A redundant E09 invocation was detected before either invocation wrote a boundary; one was interrupted while the verified E08 state still matched both mirrors, and the remaining identical invocation produced the sole E09 result. Independent re-evaluation and mirror checks passed. E09 improved the locked Relation score and is the selected Relation checkpoint; patience reset to `0/9` and the learning rate remains `0.00025`. Both 21-file Relation E09 archives were independently re-materialized, checksum-verified, state-reconstructed, and byte-compared. The runner stopped at the E09 boundary; Relation E10 and Hard-Negative have not started. No R2-P9 E28, R1, or R3 checkpoint is migrated. The suffix/allomorph registry remains outside R4. `INTERNAL_VAL`, external holdouts, and official TEST remain unopened. See [the R4 plan](docs/TurkTokenizer_v6_1_R4_Plan.md), [R4-P0 precommit](docs/TurkTokenizer_v6_1_R4_P0_Precommit.md), [R4-P0 decision](docs/TurkTokenizer_v6_1_R4_P0_Decision.md), [R4-P1 precommit](docs/TurkTokenizer_v6_1_R4_P1_Precommit.md), and [R4-P1 progress](docs/TurkTokenizer_v6_1_R4_P1_Progress.md).
