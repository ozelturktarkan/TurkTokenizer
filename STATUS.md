...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E20 remains the selected Relation checkpoint: `loss=0.0842`, macro F1 `0.7997`, minimum-family F1 `0.7081`, `POSS_HEAD=0.795`, `OBJECT=0.708`, `PARTICIPLE_HEAD=0.825`, `CASE_GOVERNOR=0.871`, `UAS=0.8840`, `LAS=0.7631`, and selection score `0.77914757`. Relation E24 subsequently completed with `loss=0.0723`, macro F1 `0.8017`, minimum-family F1 `0.6995`, `POSS_HEAD=0.800`, `OBJECT=0.700`, `PARTICIPLE_HEAD=0.829`, `CASE_GOVERNOR=0.878`, `UAS=0.8832`, `LAS=0.7612`, and selection score `0.77780560`; it did not qualify as an improvement, so patience moved from `3/9` to `4/9` and the plateau rule reduced LR from `0.000125` to `0.0000625`. The independently archived Relation resume boundary is `completed_epoch=24`, `next_epoch=25`, with rolling state stored independently in two private durable packages and the E20 best preserved in both. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
