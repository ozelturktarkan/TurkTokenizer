...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H10 completed with `loss=0.0977`, macro F1 `0.7977`, minimum-family F1 `0.7047`, `POSS_HEAD=0.795`, `OBJECT=0.705`, `PARTICIPLE_HEAD=0.816`, `CASE_GOVERNOR=0.875`, `UAS=0.8807`, `LAS=0.7609`, and selection score `0.77667997`. H10 did not exceed the selected Hard-Negative H06 best score `0.77920893`; H06 remains selected. Patience advanced `3/9 → 4/9`, and the deterministic fourth-plateau rule reduced LR from `0.00012` to `0.00006`; the full source hard-negative penalty remains `0.250000`. The H10 rolling state, unchanged cache, and preserved H06 stage-best checkpoint are stored independently in two private durable packages; H11 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
