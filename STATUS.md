...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H09 completed with `loss=0.0829`, macro F1 `0.8012`, minimum-family F1 `0.7049`, `POSS_HEAD=0.800`, `OBJECT=0.705`, `PARTICIPLE_HEAD=0.817`, `CASE_GOVERNOR=0.883`, `UAS=0.8838`, `LAS=0.7639`, and selection score `0.77917603`. H09 did not exceed the selected Hard-Negative H06 best score `0.77920893`; H06 remains selected. Patience advanced `2/9 → 3/9`, LR remains `0.00012` with no reduction, and the full source hard-negative penalty remains `0.250000`. The H09 rolling state, unchanged cache, and preserved H06 stage-best checkpoint are stored independently in two private durable packages; H10 is the next boundary. If H10 also fails to improve, the deterministic fourth-plateau rule will reduce LR. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
