...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E36 completed with `loss=0.0512`, macro F1 `0.8004`, minimum-family F1 `0.7043`, `POSS_HEAD=0.791`, `OBJECT=0.704`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.878`, `UAS=0.8852`, `LAS=0.7648`, and selection score `0.77874999`. It did not exceed the selected Relation E28 checkpoint (`loss=0.0611`, macro F1 `0.8033`, minimum-family F1 `0.7092`, `POSS_HEAD=0.796`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.881`, `UAS=0.8848`, `LAS=0.7654`, selection score `0.78178072`), so patience advanced from `7/9` to `8/9` and LR remains `0.00003125`. The independently archived Relation resume boundary is `completed_epoch=36`, `next_epoch=37`, with rolling state stored independently in two private durable packages; the E28 best remains independently archived in both packages. E37 is the next observation epoch. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
