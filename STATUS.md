...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H05 completed with `loss=0.1006`, macro F1 `0.7965`, minimum-family F1 `0.7062`, `POSS_HEAD=0.790`, `OBJECT=0.706`, `PARTICIPLE_HEAD=0.814`, `CASE_GOVERNOR=0.876`, `UAS=0.8830`, `LAS=0.7604`, and selection score `0.77653213`. H05 did not exceed the selected Hard-Negative H04 best score `0.77843714`; H04 remains selected. Patience advanced `0/9 → 1/9`, LR remains `0.00012` with no reduction, and the full source hard-negative penalty remains `0.250000`. The H05 rolling state, unchanged cache, and preserved H04 stage-best checkpoint are stored independently in two private durable packages; H06 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
