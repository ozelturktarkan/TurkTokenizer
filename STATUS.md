...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E32 completed with `loss=0.0613`, macro F1 `0.8024`, minimum-family F1 `0.7103`, `POSS_HEAD=0.798`, `OBJECT=0.710`, `PARTICIPLE_HEAD=0.824`, `CASE_GOVERNOR=0.877`, `UAS=0.8840`, `LAS=0.7637`, and selection score `0.78137619`. It did not exceed the selected Relation E28 checkpoint (`loss=0.0611`, macro F1 `0.8033`, minimum-family F1 `0.7092`, `POSS_HEAD=0.796`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.881`, `UAS=0.8848`, `LAS=0.7654`, selection score `0.78178072`), so patience advanced from `3/9` to `4/9` and the deterministic plateau rule reduced LR from `0.0000625` to `0.00003125`. The independently archived Relation resume boundary is `completed_epoch=32`, `next_epoch=33`, with rolling state stored independently in two private durable packages; the E28 best remains independently archived in both packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
