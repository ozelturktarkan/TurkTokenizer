...
Relation E15 completed from the verified E14 boundary with combined TRAIN loss `0.1358`, macro F1 `0.80992595`, minimum-family/OBJECT F1 `0.71303126`, `POSS_HEAD=0.80708661`, `OBJECT=0.71303126`, `PARTICIPLE_HEAD=0.83497053`, `CASE_GOVERNOR=0.88461538`, `UAS=0.88130111`, `LAS=0.76192830`, `UPOS=0.92007368`, and selection score `0.78611456`. E15 improved the locked Relation score and is now the selected Relation checkpoint. Patience reset from `4/9` to `0/9`, and the learning rate remains `0.000125`. Active and durable Relation state/checkpoint mirrors match byte-for-byte, while the frozen Syntax E24 parent remains unchanged. Both 21-file Relation E15 archives were independently re-materialized, checksum-verified, state-reconstructed, and byte-compared. Relation E16 and Hard-Negative have not started. No R2-P9 E28, R1, or R3 checkpoint is migrated. The suffix/allomorph registry remains outside R4. `INTERNAL_VAL`, external holdouts, and official TEST remain unopened. See [the R4 plan](docs/TurkTokenizer_v6_1_R4_Plan.md), [R4-P0 precommit](docs/TurkTokenizer_v6_1_R4_P0_Precommit.md), [R4-P0 decision](docs/TurkTokenizer_v6_1_R4_P0_Decision.md), [R4-P1 precommit](docs/TurkTokenizer_v6_1_R4_P1_Precommit.md), and [R4-P1 progress](docs/TurkTokenizer_v6_1_R4_P1_Progress.md).
