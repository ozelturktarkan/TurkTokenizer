...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E31 completed with `loss=0.0586`, macro F1 `0.8032`, minimum-family F1 `0.7055`, `POSS_HEAD=0.790`, `OBJECT=0.705`, `PARTICIPLE_HEAD=0.840`, `CASE_GOVERNOR=0.878`, `UAS=0.8842`, `LAS=0.7655`, and selection score `0.78065797`. It did not exceed the selected Relation E28 checkpoint (`loss=0.0611`, macro F1 `0.8033`, minimum-family F1 `0.7092`, `POSS_HEAD=0.796`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.881`, `UAS=0.8848`, `LAS=0.7654`, selection score `0.78178072`), so patience advanced from `2/9` to `3/9` and LR remains `0.0000625`. The independently archived Relation resume boundary is `completed_epoch=31`, `next_epoch=32`, with rolling state stored independently in two private durable packages; the E28 best remains independently archived in both packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
