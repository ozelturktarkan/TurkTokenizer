...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E3 is now the selected Relation checkpoint: `loss=0.3270`, macro F1 `0.7919`, minimum-family F1 `0.6908`, `POSS_HEAD=0.782`, `OBJECT=0.691`, `PARTICIPLE_HEAD=0.824`, `CASE_GOVERNOR=0.871`, `UAS=0.8791`, `LAS=0.7537`, and selection score `0.76890778`. It qualified as an improvement, so patience remains `0/9` and LR remains `0.00025`. The independently archived Relation resume boundary is `completed_epoch=3`, `next_epoch=4`, with state and best stored in two private durable packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
