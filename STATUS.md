...
Syntax E38 remains the selected checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. At the operator-requested E38→E39 policy boundary, only patience was explicitly reset to `0/9`; model, optimizer/RNG/sampler state, LR, and the E38 best were preserved. E39 then completed with `loss=0.1328`, CALIB syntax loss `2.1639`, `UAS=0.8856`, `LAS=0.7671`, `UPOS=0.9249`, and selection score `0.81840237`. It did not improve the selected score, so patience is `1/9`; the overfitting signal is false and its streak is `0/3`. The independently archived resume boundary is `completed_epoch=39`, `next_epoch=40`, LR `0.0000625`, with the E70 Syntax ceiling and overfitting guard active. The E38 best and E39 rolling state are stored in two private durable packages. This remains a TRAIN/CALIB screening result, not a sealed-test claim.
