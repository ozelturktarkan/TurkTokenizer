...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H17 completed with `loss=0.0543`, macro F1 `0.7998`, minimum-family F1 `0.7067`, `POSS_HEAD=0.794`, `OBJECT=0.707`, `PARTICIPLE_HEAD=0.823`, `CASE_GOVERNOR=0.875`, `UAS=0.8848`, `LAS=0.7639`, and selection score `0.77894519`. H17 did not exceed the selected H12 best score `0.78176522`; H12 remains selected. Patience advanced `4/9 → 5/9`, LR remains `0.00003`, and the full source hard-negative penalty remains `0.250000`. The H17 rolling state, unchanged cache, and preserved H12 stage-best checkpoint are stored independently in two private durable packages; H18 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
