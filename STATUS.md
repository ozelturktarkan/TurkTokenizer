...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E4 remains the selected Relation checkpoint: `loss=0.2620`, macro F1 `0.7922`, minimum-family F1 `0.6953`, `POSS_HEAD=0.793`, `OBJECT=0.695`, `PARTICIPLE_HEAD=0.816`, `CASE_GOVERNOR=0.864`, `UAS=0.8807`, `LAS=0.7549`, and selection score `0.77048013`. Relation E5 completed with `loss=0.2359`, macro F1 `0.7908`, minimum-family F1 `0.6904`, `UAS=0.8770`, `LAS=0.7524`, and selection score `0.76792676`; it did not qualify as an improvement, so patience is `1/9` and LR remains `0.00025`. The independently archived Relation resume boundary is `completed_epoch=5`, `next_epoch=6`, with rolling state stored in two private durable packages and the E4 best preserved. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
