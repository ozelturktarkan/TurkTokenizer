...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with `loss=0.0611`, macro F1 `0.8033`, minimum-family F1 `0.7092`, `POSS_HEAD=0.796`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.881`, `UAS=0.8848`, `LAS=0.7654`, and selection score `0.78178072`. Hard-Negative H01 completed with `loss=0.1338`, macro F1 `0.7921`, minimum-family F1 `0.6947`, `POSS_HEAD=0.781`, `OBJECT=0.695`, `PARTICIPLE_HEAD=0.821`, `CASE_GOVERNOR=0.871`, `UAS=0.8828`, `LAS=0.7603`, and selection score `0.77083563`. H01 is the current Hard-Negative stage best; patience is `0/9`, LR is `0.00012`, and the first warm-up source hard-negative penalty was `0.100000`. The H01 rolling state, cache, and stage-best checkpoint are stored independently in two private durable packages; H02 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
