...
Syntax E30 is now the selected checkpoint: `loss=0.2218`, `UAS=0.8839`, `LAS=0.7669`, `UPOS=0.9236`, selection score `0.81765208`. The operator-requested patience reset at the E29→E30 boundary was applied to the patience counter only; model, optimizer LR, RNG state, and the prior best were preserved. E30 qualified as an improvement and therefore kept patience at `0/9`. Syntax E37 is now the selected checkpoint: `loss=0.1393`, `UAS=0.8858`, `LAS=0.7667`, `UPOS=0.9247`, selection score `0.81825411`. It exceeded the prior E30 best by the required `0.0001`, so patience reset `6/9 → 0/9`; LR remained `0.0000625`. The latest independently archived resume boundary is `completed_epoch=37`, `next_epoch=38`, patience `0/9`, and LR `0.0000625`; the E37 checkpoint and rolling state are independently archived in two private durable packages. The rolling state and selected E30 checkpoint are independently archived in two private durable packages. This remains a TRAIN/CALIB screening result, not a sealed-test claim.
