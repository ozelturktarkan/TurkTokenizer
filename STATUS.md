...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H06 completed as a new stage best with `loss=0.0885`, macro F1 `0.7995`, minimum-family F1 `0.7087`, `POSS_HEAD=0.793`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.824`, `CASE_GOVERNOR=0.872`, `UAS=0.8842`, `LAS=0.7633`, and selection score `0.77920893`. Patience reset `1/9 → 0/9`, LR remains `0.00012` with no reduction, and the full source hard-negative penalty remains `0.250000`. The H06 rolling state, unchanged cache, and new H06 stage-best checkpoint are stored independently in two private durable packages; H07 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
