...
Syntax E30 is now the selected checkpoint: `loss=0.2218`, `UAS=0.8839`, `LAS=0.7669`, `UPOS=0.9236`, selection score `0.81765208`. The operator-requested patience reset at the E29→E30 boundary was applied to the patience counter only; model, optimizer LR, RNG state, and the prior best were preserved. E30 qualified as an improvement and therefore kept patience at `0/9`. Syntax E34 completed with `loss=0.1727`, `UAS=0.8831`, `LAS=0.7635`, `UPOS=0.9248`, and selection score `0.81550004`; it did not exceed the E30 best by the required `0.0001`. Patience advanced `3/9 → 4/9`, triggering the precommitted learning-rate reduction from `0.000125` to `0.0000625`. The latest independently archived resume boundary is `completed_epoch=34`, `next_epoch=35`, patience `4/9`, and LR `0.0000625`; E30 remains the selected checkpoint. The rolling state and selected E30 checkpoint are independently archived in two private durable packages. This remains a TRAIN/CALIB screening result, not a sealed-test claim.
