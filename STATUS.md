...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E20 remains the selected Relation checkpoint: `loss=0.0842`, macro F1 `0.7997`, minimum-family F1 `0.7081`, `POSS_HEAD=0.795`, `OBJECT=0.708`, `PARTICIPLE_HEAD=0.825`, `CASE_GOVERNOR=0.871`, `UAS=0.8840`, `LAS=0.7631`, and selection score `0.77914757`. Relation E21 subsequently completed with `loss=0.0742`, macro F1 `0.7978`, minimum-family F1 `0.7094`, `POSS_HEAD=0.786`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.824`, `CASE_GOVERNOR=0.872`, `UAS=0.8844`, `LAS=0.7629`, and selection score `0.77839642`; it did not qualify as an improvement, so patience moved from `0/9` to `1/9` and LR remains `0.000125`. The independently archived Relation resume boundary is `completed_epoch=21`, `next_epoch=22`, with rolling state stored independently in two private durable packages and the E20 best preserved in both. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
