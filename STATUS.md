...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H03 completed with `loss=0.1119`, macro F1 `0.7958`, minimum-family F1 `0.7010`, `POSS_HEAD=0.776`, `OBJECT=0.701`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.879`, `UAS=0.8819`, `LAS=0.7613`, and selection score `0.77466642`. H03 did not exceed the selected Hard-Negative H02 best score `0.77500896`; H02 remains selected. Patience advanced `0/9 → 1/9`, LR remains `0.00012` with no reduction, and the third warm-up source hard-negative penalty was `0.200000`. The H03 rolling state, unchanged cache, and preserved H02 stage-best checkpoint are stored independently in two private durable packages; H04 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
