...
Syntax E38 is the current selected checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. It exceeded the E37 best by the required `0.0001`. At the operator-requested E38→E39 policy boundary, only the patience counter was explicitly reset to `0/9`; model weights, optimizer state and LR, RNG/sampler state, and the E38 best were preserved. The independently archived resume boundary is `completed_epoch=38`, `next_epoch=39`, patience `0/9`, LR `0.0000625`, with the E70 Syntax ceiling and overfitting guard active. The E38 best and rolling resume state are stored in two private durable packages. The interrupted, unarchived E39 attempt is not counted and will be rerun from this boundary. This remains a TRAIN/CALIB screening result, not a sealed-test claim.
