...
Relation closed at E31 under the precommitted patience rule with E22 retained as the selected Relation checkpoint at `0.78921340`. Hard-Negative H03 completed from the verified H02 boundary using the unchanged deterministic TRAIN-only cache (82 CASE_GOVERNOR, 432 OBJECT, 290 PARTICIPLE_HEAD, and 426 POSS_HEAD examples) and final warm-up source hard-negative penalty `0.200000`. H03 produced TRAIN loss `0.1306`, macro F1 `0.81389095`, minimum-family/OBJECT F1 `0.71215207`, `POSS_HEAD=0.81325301`, `OBJECT=0.71215207`, `PARTICIPLE_HEAD=0.84126984`, `CASE_GOVERNOR=0.88888889`, `UAS=0.88520981`, `LAS=0.76381526`, `UPOS=0.92155629`, and selection score `0.78862166`. H03 improved the previous H01 best of `0.78850593`, became the selected Hard-Negative checkpoint, and reset patience to `0/9`; the learning rate remains `0.00012`. Active and durable state, cache, and checkpoint mirrors match byte-for-byte, while the locked Relation E22 and Syntax E24 parents remain unchanged. Both 24-file H03 archives were independently re-materialized, checksum-verified, state-reconstructed, and byte-compared. H04 has not started. No R2-P9 E28, R1, or R3 checkpoint is migrated. The suffix/allomorph registry remains outside R4. `INTERNAL_VAL`, external holdouts, and official TEST remain unopened. See [the R4 plan](docs/TurkTokenizer_v6_1_R4_Plan.md), [R4-P0 precommit](docs/TurkTokenizer_v6_1_R4_P0_Precommit.md), [R4-P0 decision](docs/TurkTokenizer_v6_1_R4_P0_Decision.md), [R4-P1 precommit](docs/TurkTokenizer_v6_1_R4_P1_Precommit.md), and [R4-P1 progress](docs/TurkTokenizer_v6_1_R4_P1_Progress.md).
