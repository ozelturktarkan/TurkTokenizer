...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H02 completed as a new stage best with `loss=0.1029`, macro F1 `0.7974`, minimum-family F1 `0.6991`, `POSS_HEAD=0.785`, `OBJECT=0.699`, `PARTICIPLE_HEAD=0.830`, `CASE_GOVERNOR=0.875`, `UAS=0.8832`, `LAS=0.7588`, and selection score `0.77500896`. Patience reset/remained `0/9`, LR remains `0.00012`, and the second warm-up source hard-negative penalty was `0.150000`. The H02 rolling state, cache, and new stage-best checkpoint are stored independently in two private durable packages; H03 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
