...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E17 is now the selected Relation checkpoint: `loss=0.1053`, macro F1 `0.7997`, minimum-family F1 `0.7032`, `POSS_HEAD=0.803`, `OBJECT=0.703`, `PARTICIPLE_HEAD=0.819`, `CASE_GOVERNOR=0.874`, `UAS=0.8834`, `LAS=0.7643`, and selection score `0.77786693`. It qualified as an improvement after the E16 learning-rate reduction, so patience reset from `4/9` to `0/9` and LR remains `0.000125`. The independently archived Relation resume boundary is `completed_epoch=17`, `next_epoch=18`, with rolling state and the E17 best stored independently in two private durable packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
