...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E12 remains the selected Relation checkpoint: `loss=0.1520`, macro F1 `0.7977`, minimum-family F1 `0.7011`, `POSS_HEAD=0.786`, `OBJECT=0.701`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.876`, `UAS=0.8807`, `LAS=0.7586`, and selection score `0.77550941`. Relation E15 subsequently completed with `loss=0.1567`, macro F1 `0.7930`, minimum-family F1 `0.7047`, `UAS=0.8780`, `LAS=0.7565`, and selection score `0.77342839`; it did not qualify as an improvement, so patience is `3/9` and LR remains `0.00025`. The independently archived Relation resume boundary is `completed_epoch=15`, `next_epoch=16`, with rolling state stored in two private durable packages and the E12 best preserved independently in both. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
