...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E12 is now the selected Relation checkpoint: `loss=0.1520`, macro F1 `0.7977`, minimum-family F1 `0.7011`, `POSS_HEAD=0.786`, `OBJECT=0.701`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.876`, `UAS=0.8807`, `LAS=0.7586`, and selection score `0.77550941`. It qualified as an improvement over the E9 best under the fixed `0.0001` threshold, so patience reset from `2/9` to `0/9` and LR remains `0.00025`. The independently archived Relation resume boundary is `completed_epoch=12`, `next_epoch=13`, with rolling state and the E12 best stored in two private durable packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
