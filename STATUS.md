...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training has now started from that frozen checkpoint. Relation E1 completed with `loss=0.3914`, macro F1 `0.7809`, minimum-family F1 `0.6964`, `POSS_HEAD=0.767`, `OBJECT=0.696`, `PARTICIPLE_HEAD=0.811`, `CASE_GOVERNOR=0.849`, `UAS=0.8792`, `LAS=0.7581`, and selection score `0.76434490`. It is the initial Relation best; patience is `0/9` and LR is `0.00025`. The independently archived Relation resume boundary is `completed_epoch=1`, `next_epoch=2`, with state and best stored in two private durable packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
