...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation E6 is now the selected Relation checkpoint: `loss=0.2132`, macro F1 `0.7954`, minimum-family F1 `0.6978`, `POSS_HEAD=0.787`, `OBJECT=0.698`, `PARTICIPLE_HEAD=0.834`, `CASE_GOVERNOR=0.863`, `UAS=0.8785`, `LAS=0.7554`, and selection score `0.77292408`. It qualified as an improvement, so patience reset from `1/9` to `0/9` and LR remains `0.00025`. The independently archived Relation resume boundary is `completed_epoch=6`, `next_epoch=7`, with rolling state and the E6 best stored in two private durable packages. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
