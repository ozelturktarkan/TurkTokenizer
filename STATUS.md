...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H04 completed as a new stage best with `loss=0.0954`, macro F1 `0.7997`, minimum-family F1 `0.7059`, `POSS_HEAD=0.785`, `OBJECT=0.706`, `PARTICIPLE_HEAD=0.822`, `CASE_GOVERNOR=0.885`, `UAS=0.8829`, `LAS=0.7630`, and selection score `0.77843714`. Patience reset `1/9 → 0/9`, LR remains `0.00012` with no reduction, and the full source hard-negative penalty is now `0.250000` after warm-up. The H04 rolling state, unchanged cache, and new H04 stage-best checkpoint are stored independently in two private durable packages; H05 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
