...
Syntax E38 remains the selected checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. The operator-requested E38→E39 patience reset preserved model, optimizer/RNG/sampler state, LR, and the E38 best. E40 completed with `loss=0.1272`, CALIB syntax loss `2.1979`, `UAS=0.8853`, `LAS=0.7654`, `UPOS=0.9251`, and selection score `0.81737353`. It did not improve the selected score; patience is `2/9`. Because training loss fell while CALIB loss rose and selection did not improve, the overfitting signal is true for the first consecutive epoch (`1/3`); training continues until the signal is confirmed for three consecutive epochs or another stop guard fires. The independently archived resume boundary is `completed_epoch=40`, `next_epoch=41`, LR `0.0000625`. The E38 best and E40 rolling state are stored in two private durable packages. This remains a TRAIN/CALIB screening result, not a sealed-test claim.
