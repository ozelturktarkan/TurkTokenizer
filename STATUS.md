...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`. E37 produced `loss=0.0511`, macro F1 `0.7996`, minimum-family F1 `0.7052`, `POSS_HEAD=0.789`, `OBJECT=0.705`, `PARTICIPLE_HEAD=0.827`, `CASE_GOVERNOR=0.877`, `UAS=0.8850`, `LAS=0.7644`, and selection score `0.77849553`; it did not improve over the selected Relation E28 checkpoint. E28 is therefore frozen as the Relation checkpoint with `loss=0.0611`, macro F1 `0.8033`, minimum-family F1 `0.7092`, `POSS_HEAD=0.796`, `OBJECT=0.709`, `PARTICIPLE_HEAD=0.828`, `CASE_GOVERNOR=0.881`, `UAS=0.8848`, `LAS=0.7654`, and selection score `0.78178072`. The final E37 state, completion marker, and frozen E28 checkpoint are stored independently in two private durable packages. Hard-Negative has not started. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
