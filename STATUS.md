...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H12 produced a new selected stage best with `loss=0.0722`, macro F1 `0.8020`, minimum-family F1 `0.7121`, `POSS_HEAD=0.798`, `OBJECT=0.712`, `PARTICIPLE_HEAD=0.820`, `CASE_GOVERNOR=0.879`, `UAS=0.8843`, `LAS=0.7654`, and selection score `0.78176522`. H12 exceeded the previous H11 best score `0.78127320`; H12 is now selected. Patience remains `0/9`, LR remains `0.00006`, and the full source hard-negative penalty remains `0.250000`. The H12 rolling state, unchanged cache, and new H12 stage-best checkpoint are stored independently in two private durable packages; H13 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
