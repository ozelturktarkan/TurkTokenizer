...
- v6.0 R3-P2 control is complete; candidate Relation completed at E50 and
  candidate Hard-Negative E06 is persisted and verified.
...
packages were verified. Candidate Hard-Negative E06 then completed; its active
and durable state, fixed cache, selected checkpoint, and two independent
persistent packages were verified. E07 is the next authorized invocation.
