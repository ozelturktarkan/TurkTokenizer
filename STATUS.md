...
Syntax training closed safely at E42 after the overfitting guard fired at `3/3`. Syntax E38 remains frozen as the selected parent checkpoint: `loss=0.1365`, `UAS=0.8867`, `LAS=0.7670`, `UPOS=0.9252`, selection score `0.81872136`. Relation training closed at E37 after patience reached `9/9`; E28 is frozen as the Relation checkpoint with selection score `0.78178072`. Hard-Negative H15 completed after recovery with `loss=0.0624`, macro F1 `0.8018`, minimum-family F1 `0.7052`, `POSS_HEAD=0.798`, `OBJECT=0.705`, `PARTICIPLE_HEAD=0.821`, `CASE_GOVERNOR=0.883`, `UAS=0.8858`, `LAS=0.7656`, and selection score `0.77990071`. H15 did not exceed the selected H12 best score `0.78176522`; H12 remains selected. Patience advanced `2/9 → 3/9`, LR remains `0.00006`, and the full source hard-negative penalty remains `0.250000`. The H15 rolling state, unchanged cache, and preserved H12 stage-best checkpoint are stored independently in two private durable packages; H16 is the next boundary. INTERNAL_VAL, external holdouts, and official TEST remain unopened. These are TRAIN/CALIB screening results, not sealed-test claims.
