...
> Status: PRECOMMITTED — start gate passed; Relation E01 pending.
...
No Relation epoch has started at this public boundary. `INTERNAL_VAL`, external BOUN/IMST/Penn holdouts, and official TEST remain unopened.
