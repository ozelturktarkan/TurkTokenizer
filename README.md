...
Syntax epoch 7 completed with selection score `0.78362836`
(`UAS=0.8534`, `LAS=0.7282`, `UPOS=0.9070`). It did not exceed the E06
best (`0.78736634`), so the selected checkpoint remains E06 and patience is
`1/5`.
