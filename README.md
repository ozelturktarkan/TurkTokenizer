...
epochs; epoch 20 remains selected with score `0.80719741`. Relation epoch 4
reached a new-best selection score `0.77212351` (`macro=0.7946`,
`minimum-family=0.6977`, `UAS=0.8764`, `LAS=0.7538`) with patience `0/5`.
