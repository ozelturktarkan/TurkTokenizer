...
epochs; epoch 20 remains selected with score `0.80719741`. Relation epoch 2
reached a new-best selection score `0.76966063` (`macro=0.7883`,
`minimum-family=0.7017`, `UAS=0.8764`, `LAS=0.7555`) with patience `0/5`.
