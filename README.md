...
Syntax epoch 20 reached a new-best selection score `0.80719741`
(`UAS=0.8747`, `LAS=0.7548`, `UPOS=0.9190`), replaced the selected checkpoint,
and reset patience from `2/5` to `0/5`.
