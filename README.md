...
epochs; epoch 20 remains selected with score `0.80719741`. Relation epoch 3
reached a new-best selection score `0.77077397` (`macro=0.7923`,
`minimum-family=0.6970`, `UAS=0.8771`, `LAS=0.7558`) with patience `0/5`.
