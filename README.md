...
| v6.1 R4-P2 matched focal control | Active; Relation closed at E25; E16 selected; H01 pending | 0.8138 | 0.7207 | 0.8831 | 0.7647 |
...
The final R4-P1 screen used the unchanged selected H03 checkpoint and was reproduced exactly in two independent executions, with a third independent CPU recomputation. It yielded macro F1 `0.81389095`, minimum-family/OBJECT F1 `0.71215207`, `UAS=0.88520981`, and `LAS=0.76381526`. Macro gain over A1 was below the precommitted screen threshold and minimum-family F1 regressed, so the decision is `DROP_AFTER_SCREEN`. R4-P1 nevertheless supplies the reproducible fresh focal parent required for an R4-P2 interference-isolation precommit. Its two private 37-file final-closure packages were independently re-materialized and checksum-verified. The R4-P2 matched focal control is precommitted and passed its zero-step start gate. It restores only the verified R4-P1 Syntax E24 parent, reuses the unchanged focal trainer/objective, and disables adapters, PCGrad, and ranking loss. Relation closed at E25 under the locked patience rule; E16 remains selected at score `0.79078781`, with macro F1 `0.81382507`, minimum-family/OBJECT F1 `0.72072072`, `UAS=0.88309821`, and `LAS=0.76466888`. Both 29-file E25 closure packages passed independent checksum, byte-equality, checkpoint-preservation, completion-marker, and reconstructed-state verification after re-materialization. E26–E30 were not run because Relation was already closed; Hard-Negative H01 is pending. See [the control progress log](docs/TurkTokenizer_v6_1_R4_P2_Control_Progress.md) and [public Relation closure summary](audits/TurkTokenizer_v6_1_R4_P2_Control_Relation_Public_Closure.json). Sealed evaluation remains unopened.
