...
Syntax epoch 18 completed with selection score `0.80405248`
(`UAS=0.8702`, `LAS=0.7520`, `UPOS=0.9183`). It did not exceed the epoch-17
best score `0.80532393`, so that checkpoint remains selected and patience is
`1/5`.
