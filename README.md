...
| v6.1 R4-P1 fresh repaired-lattice parent | Relation E09 complete; E09 selected | 0.8011 | 0.7153 | 0.8758 | 0.7551 |
...
R3-P3 is closed as `DROP_AFTER_SCREEN`, and the R3 line is complete. Its corrected v2 transfer preserved the protected R1 metrics but passed only three of twelve gates, confirming that the R3-P2 ranking gain was representation- and calibration-entangled rather than transferable as standalone scorer tensors. Final R3-P3 A/B closure packages were independently re-materialized and checksum-verified. See [the corrected v2 precommit](docs/TurkTokenizer_v6_0_R3_P3_v2_Precommit.md), [the decision](docs/TurkTokenizer_v6_0_R3_P3_Decision.md), and [the R4 plan](docs/TurkTokenizer_v6_1_R4_Plan.md). R4-P0 then passed its zero-update TRAIN-only gradient-conflict audit; see the [R4-P0 precommit](docs/TurkTokenizer_v6_1_R4_P0_Precommit.md) and [decision](docs/TurkTokenizer_v6_1_R4_P0_Decision.md). R4-P1 is the precommitted fresh repaired-lattice reconstruction with no adapter, PCGrad, ranking loss, or checkpoint migration; see [the R4-P1 precommit](docs/TurkTokenizer_v6_1_R4_P1_Precommit.md). Syntax closed safely at E27 when its overfit guard reached `3/3`, with E24 frozen as the selected parent. Relation E09 completed from the verified E08 boundary with combined TRAIN loss `0.1948`, macro F1 `0.80110980`, minimum-family/OBJECT F1 `0.71530249`, `POSS_HEAD=0.79958463`, `OBJECT=0.71530249`, `PARTICIPLE_HEAD=0.81331988`, `CASE_GOVERNOR=0.87623220`, `UAS=0.87581993`, `LAS=0.75505436`, `UPOS=0.91917513`, and selection score `0.78069476`. A redundant E09 invocation was detected before either invocation wrote a boundary; one was interrupted while E08 remained intact, and the remaining identical invocation produced the sole E09 result. Independent re-evaluation and all mirror/archive checks passed. E09 improved the locked Relation score and became selected; patience reset to `0/9` and the learning rate remains `0.00025`. Both 21-file E09 archives were independently re-materialized and checksum-verified. The runner stopped at the E09 boundary; Relation E10 and Hard-Negative have not started. Sealed evaluation remains unopened.
