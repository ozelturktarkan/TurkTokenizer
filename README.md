...
| v6.1 R4-P1 fresh repaired-lattice parent | Relation closed at E31; E22 selected | 0.8120 | 0.7176 | 0.8851 | 0.7644 |
...
R3-P3 is closed as `DROP_AFTER_SCREEN`, and the R3 line is complete. Its corrected v2 transfer preserved the protected R1 metrics but passed only three of twelve gates, confirming that the R3-P2 ranking gain was representation- and calibration-entangled rather than transferable as standalone scorer tensors. Final R3-P3 A/B closure packages were independently re-materialized and checksum-verified. See [the corrected v2 precommit](docs/TurkTokenizer_v6_0_R3_P3_v2_Precommit.md), [the decision](docs/TurkTokenizer_v6_0_R3_P3_Decision.md), and [the R4 plan](docs/TurkTokenizer_v6_1_R4_Plan.md). R4-P0 then passed its zero-update TRAIN-only gradient-conflict audit; see the [R4-P0 precommit](docs/TurkTokenizer_v6_1_R4_P0_Precommit.md) and [decision](docs/TurkTokenizer_v6_1_R4_P0_Decision.md). R4-P1 is the precommitted fresh repaired-lattice reconstruction with no adapter, PCGrad, ranking loss, or checkpoint migration; see [the R4-P1 precommit](docs/TurkTokenizer_v6_1_R4_P1_Precommit.md). Syntax closed safely at E27 when its overfit guard reached `3/3`, with E24 frozen as the selected parent. Relation closed at E31 under the precommitted patience rule. E31 completed from the verified E30 boundary under the reduced learning rate with combined TRAIN loss `0.1432`, macro F1 `0.81202776`, minimum-family/OBJECT F1 `0.71755188`, `POSS_HEAD=0.81130172`, `OBJECT=0.71755188`, `PARTICIPLE_HEAD=0.83657588`, `CASE_GOVERNOR=0.88268156`, `UAS=0.88507503`, `LAS=0.76435439`, `UPOS=0.92065774`, and selection score `0.78902592`. E31 did not improve the locked Relation score, so E22 remains selected at `0.78921340`; patience reached `9/9`, and the learning rate remained `0.0000625`. The automatic post-Relation handoff was interrupted before any Hard-Negative cache, state, metric, checkpoint, or epoch was produced; E32–E34 did not run. Both 22-file E31 closure archives were independently re-materialized and checksum-verified, and all state/checkpoint/completion-marker mirrors matched. Sealed evaluation remains unopened.
